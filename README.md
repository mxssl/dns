...
[Linux](https://github.com/mxssl/dns/releases/download/1.0.3/dns_Linux_x86_64.tar.gz)

[Windows](https://github.com/mxssl/dns/releases/download/1.0.3/dns_Windows_x86_64.tar.gz)

[MacOS](https://github.com/mxssl/dns/releases/download/1.0.3/dns_Darwin_x86_64.tar.gz)
...
```bash
wget https://github.com/mxssl/dns/releases/download/1.0.3/dns_Linux_x86_64.tar.gz
...
```bash
wget https://github.com/mxssl/dns/releases/download/1.0.3/dns_Darwin_x86_64.tar.gz
