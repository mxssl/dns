...
```bash
wget https://github.com/mxssl/dns/releases/download/0.0.9/dns_Linux_x86_64.tar.gz
...
```bash
wget https://github.com/mxssl/dns/releases/download/0.0.9/dns_Darwin_x86_64.tar.gz
